...
const Support = () => {
    ...
    const changelog = [
        ...
        },
        {
            ...
            date: '2026-08-29',
            changes: [
                'Correctif — Sécurisation de la dépendance dompurify : l\'assainissement HTML introduit en v1.47.2 (chat, éditeur, fiches produits) ne résolvait que par accident — dompurify était embarqué comme dépendance transitive de html2pdf.js, sans déclaration explicite dans package.json. Désormais déclaré (^3.4.14), le correctif de sécurité survit au retrait de html2pdf.js opéré dans ce même lot',
